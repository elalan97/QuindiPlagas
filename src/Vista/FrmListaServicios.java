...
public class FrmListaServicios extends javax.swing.JInternalFrame {
    ...
    public FrmListaServicios() {
        initComponents();
        this.setSize(new Dimension(1720, 650));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1260, 65, -1, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1345, 65, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (fecha.isEmpty()) {
            ...
            try {
                ...
                ctlAgenda.reporteAgendaExcel(fecha);
                JOptionPane.showMessageDialog(null, "Agenda generada");
