...
public class DetalleCliente extends javax.swing.JFrame {
    ...
    public void cargarCampos() {
        ...
        direccion = ctlServicio.direccionAlmacenado;

        DtoInformeServicio dtoInformeServicio = ctlServicio.buscarDtoInformeServicio(codigo, direccion);
        ArrayList<DtoServicio> servicios = ctlServicio.listarServicios(dtoInformeServicio.getCodigo());

        txtApellidoCliente.setText(dtoInformeServicio.getApellido());
        txtCelularCliente.setText(dtoInformeServicio.getCelular());
        txtCiudadNegocio.setText(dtoInformeServicio.getNombreCiudad());
        txtCodigoCliente.setText(dtoInformeServicio.getCodigo());
        txtCorreoCliente.setText(dtoInformeServicio.getCorreo());
        txtDepartamentoNegocio.setText(dtoInformeServicio.getNombreMunicipio());
        txtDireccionNegocio.setText(dtoInformeServicio.getDireccion());
        txtEncagadoNegocio.setText(dtoInformeServicio.getEncargado());
        txtNitNegocio.setText(dtoInformeServicio.getNit());
        txtNombreCliente.setText(dtoInformeServicio.getNombre());
        txtNombreNegocio.setText(dtoInformeServicio.getNombreNegocio());
        txtTipoCliente.setText(dtoInformeServicio.getTipo());
